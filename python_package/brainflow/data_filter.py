...
from exit_codes import BrainFlowExitCodes, BrainFlowError
from utils import check_memory_layout_row_major, LogLevels
...
class DataFilter(object):
    """DataFilter class contains methods for signal processing"""
    ...
    @classmethod
    def detect_peaks_z_score(cls, data, lag=3, threshold=3.5, influence=0.1):
